		...
		<%
		 ...
		 <% if(list.size()!=0){%>
			...
			<table border="1" width="100%">
				...
				%>
				<tr>
					<td align="center"><input type="checkbox" class="checkbox" name="ids" value="<%=bean.getId()%>" <%if(bean.getRoleId()==RoleBean.ADMIN) {%><%="disabled" %><%} %>></td>
					...
					<%if(bean.getRoleId()==RoleBean.ADMIN){ %>onclick="return false;"<%} %>>Edit</a></td>
				</tr>
				<%
					}
				%>
